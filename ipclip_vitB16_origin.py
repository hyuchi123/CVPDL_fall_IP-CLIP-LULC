...
class IPCLIPB16(TrainerXU):
    ...
    def forward_backward(self, batch_s, batch_t):
        ...
        if prec == "amp":
            with autocast('cuda'):
                ...
                upper_bound = 10
                if loss_ce_t > upper_bound:
                    loss_ce_t = torch.clamp(loss_ce_t, 0, upper_bound)
                if loss_ce_is > upper_bound:
                    loss_ce_is = torch.clamp(loss_ce_is, 0, upper_bound)
                if loss_ce_it > upper_bound:
                    loss_ce_it = torch.clamp(loss_ce_it, 0, upper_bound)
                if loss_smn > upper_bound:
                    loss_smn = torch.clamp(loss_smn, 0, upper_bound)
    ...
    def test(self):
        ...
        print("test_loader_x domain:", getattr(self.test_loader_x.dataset, "domain", "unknown"))
        ...
        print(f"Evaluate on the *{split}* set")
        print("test_loader_1 domain:", getattr(self.test_loader_1.dataset, "domain", "unknown"))
        ...
        print(f"Evaluate on the *{split}* set")
        print("test_loader_2 domain:", getattr(self.test_loader_2.dataset, "domain", "unknown"))
        ...
        print(f"Evaluate on the *{split}* set")
        print("test_loader_3 domain:", getattr(self.test_loader_3.dataset, "domain", "unknown"))
        ...
        print(f"Evaluate on the *{split}* set")
        print("test_loader_4 domain:", getattr(self.test_loader_4.dataset, "domain", "unknown"))
