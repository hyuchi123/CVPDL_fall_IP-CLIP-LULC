...
def build_transform(cfg, is_train=False, is_free=False, choices=None):
    ...
    if is_train:
        ...
        return _build_transform_free(cfg, choices, target_size, normalize)
    else:
